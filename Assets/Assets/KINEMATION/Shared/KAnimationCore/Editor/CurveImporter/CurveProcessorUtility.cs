...
namespace KINEMATION.Shared.KAnimationCore.Editor.CurveImporter
{
    ...
    public class CurveProcessorUtility
    {
        ...
        private const string LegacyCustomCurvePrefix = "CustomCurve";
        ...
        private static bool TryParseCurveQuery(string property, out CurveQuery curveQuery)
        {
            ...
            if (!usesLocalFileId &&
                !string.Equals(prefix, CustomCurvePrefix, StringComparison.Ordinal) &&
                !string.Equals(prefix, LegacyCustomCurvePrefix, StringComparison.Ordinal))
            {
                return false;
            }

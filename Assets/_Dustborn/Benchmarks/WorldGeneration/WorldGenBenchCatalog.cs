...
public static class WorldGenBenchCatalog
{
    ...
    private static List<WorldGenBenchSpec> Build()
    {
        var all = new List<WorldGenBenchSpec>
        {
            ...
            new("SET-01", "P0", "EM", "set.hubs", NONE, "site candidates, relief probes and house counts"),
            new("SET-02", "P1", "EM", "set.hubsEmpty", new[] { "shape=flooded", "shape=steep" }, "no suitable hub, and the empty downstream"),
            new("SET-03", "P0", "EM", "set.roads", new[] { "hubs=4", "hubs=16", "" }, "highway A star between settlement gates"),
            ...
            new("SET-07", "P0", "EM", "set.carve", NONE, "settlement levelling, streets and highways carved into the terrain"),
            new("SET-08", "P0", "EM", "set.settlements", NONE, "block lattice, street spanning tree and gates for every site"),
            new("SET-09", "P1", "EM", "set.blocks", new[] { "houses=12", "houses=60", "houses=160", "loopChance=0" }, "one settlement: block growth, spanning tree, frontages"),
            new("SET-10", "P1", "EM", "set.pads", NONE, "settlement levelling: distance to blocks and ground blur"),
            new("SET-11", "P1", "EM", "set.lots", new[] { "", "lotGap=12" }, "lot subdivision along street frontage"),
            new("SET-12", "P1", "EM", "set.houses", new[] { "bias=1", "bias=2.4", "bias=4" }, "house count draw over the sites"),

...
public static class WorldGenBenchCatalog
{
    ...
    private static List<WorldGenBenchSpec> Build()
    {
        var all = new List<WorldGenBenchSpec>
        {
            ...
            new("SET-01", "P0", "EM", "set.hubs", NONE, "typed settlement sites over the buildable tile raster, profile spacing and relief probes"),
            new("SET-02", "P1", "EM", "set.hubsEmpty", new[] { "shape=flooded", "shape=steep" }, "no suitable hub, and the empty downstream"),
            new("SET-03", "P0", "EM", "set.roads", new[] { "hubs=4", "hubs=16", "" }, "highway routing from gateway to gateway with corridor joins and junction splitting"),
            new("SET-04", "P1", "EM", "set.edges", new[] { "linkRatio=1", "linkRatio=1.3", "linkRatio=2" }, "Delaunay candidates, scored backbone and spatially spread loops"),
            ...
            new("SET-07", "P0", "EM", "set.carve", NONE, "per-tile settlement surfaces, then streets and regional roads carved by road kind"),
            new("SET-08", "P0", "EM", "set.settlements", NONE, "tile lattice, gateways, port solver and tile templates for every site"),
            new("SET-09", "P1", "EM", "set.tiles", new[] { "type=City", "type=Town", "type=CountryTown", "type=GhostTown", "type=City;loopDensity=0" }, "one settlement: arms, shaped growth, zoning, port solver, templates"),
            new("SET-10", "P1", "EM", "set.pads", NONE, "settlement terrain: relaxed tile corner heights and a skirt"),
            new("SET-11", "P1", "EM", "set.lots", new[] { "", "lotGap=12" }, "lot subdivision along tile frontages"),
            new("SET-12", "P1", "EM", "set.mix", new[] { "scale=0.5", "scale=1", "scale=2" }, "settlement mix placement over the sites"),
            new("SET-13", "P1", "EM", "set.index", new[] { "segments=0", "segments=1000", "segments=10000" }, "RoadProximity, LotIndex and MinHeap"),
            new("SET-14", "P0", "EM", "set.carveStreets", NONE, "street carving over levelled settlements"),
            new("SET-15", "P0", "EM", "set.topology", NONE, "road topology validator: connectivity, ports, crossings, grades, radii, gateways, POI clearance"),
            new("SET-16", "P1", "EM", "set.dirt", NONE, "dirt access spurs split from highways toward rural sites"),
            ...
            new("POI-03", "P1", "EM", "poi.rural", NONE, "rural buildings at the end of dirt access roads"),
            ...
            new("MAT-07", "P1", "EM", "mat.oneGround", new[] { "oneGround=true", "oneGround=false", "oneGround=false;noRoads=true" }, "OneGroundPerBiome and a missing road network"),

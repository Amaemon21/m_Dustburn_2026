...
public class WorldBuildSettings : ScriptableObject
{
    ...
    [field: SerializeField, Foldout("Quality"), Range(1, 6)] public int LodCount { get; private set; } = 5;
    [field: SerializeField, Foldout("Quality"), MinValue(32f)] public float NearDistance { get; private set; } = 96f;
    [field: SerializeField, Foldout("Quality"), Range(256, 4096)] public int ControlResolution { get; private set; } = 2048;

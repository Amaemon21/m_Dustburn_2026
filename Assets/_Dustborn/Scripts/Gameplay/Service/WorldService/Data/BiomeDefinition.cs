...
public class BiomeDefinition : ScriptableObject
{
    ...
    [field: Tooltip("Grounds of this biome, stacked like layers in an image editor: the base first, then noise patches, then shelves keyed to slope and height, each laid over the ones before it. Keep every ground at the same TileSize so their facets line up where they meet. The world-wide layer budget is MaxTerrainLayers in the config.")]
